...
buttons = [
    ...
    [
        InlineKeyboardButton(text="About Bagaskara", callback_data="emiko_"),
    ...
    [
        InlineKeyboardButton(
            text="➗ Add Emiko To Your Group ➗", url="t.me/oneupdirty_bot?startgroup=new"),
    ],
]
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text="๏ I'm *Bagaskara*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_Bagaskara licensed under the GNU General Public License v3.0_"
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, Bagaskara now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="t.me/allfucek"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/loveisfuckedup"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
